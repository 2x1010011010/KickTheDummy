...
namespace PaintIn3D
{
	...
	public class P3dModel : MonoBehaviour
	{
		...
		private void CacheRenderer()
		{
			...
			{
				Debug.LogError("This P3dModel/P3dPaintable (" + name + ") doesn't have a suitable Renderer, so it cannot be painted.", this);
			}
		}
		...
		protected virtual void TryGetPrepared(P3dCoord coord)
		{
